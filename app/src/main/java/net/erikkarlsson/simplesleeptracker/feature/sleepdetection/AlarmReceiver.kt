...
import net.erikkarlsson.simplesleeptracker.data.sleepdetection.SleepDetectionAlarm.Companion.START_SLEEP_DETECTION_ACTION
import net.erikkarlsson.simplesleeptracker.data.sleepdetection.SleepDetectionAlarm.Companion.STOP_SLEEP_DETECTION_ACTION
