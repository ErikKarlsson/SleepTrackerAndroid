...
interface StatisticsDaoCoroutines {
    ...
    fun getAverageSleepDurationDayOfWeek(from: String, to: String): Flow<List<DayOfWeekHours>>
    ...
    fun getLongestSleep(from: String, to: String): Flow<SleepEntity>
    ...
    fun getShortestSleep(from: String, to: String): Flow<SleepEntity>
    ...
    fun getAverageBedtimeMidnightOffsetInSecondsForDaysOfWeek(from: String, to: String): Flow<List<DayOfWeekMidnightOffset>>
    ...
    fun getAverageBedtimeMidnightOffsetInSeconds(from: String, to: String): Flow<Int>
    ...
    fun getAverageWakeUpMidnightOffsetInSecondsForDaysOfWeek(from: String, to: String): Flow<List<DayOfWeekMidnightOffset>>
    ...
    fun getCountGroupedByYearMonth(): Flow<List<SleepCountYearMonth>>
